...
<div class="box box-primary">
    <form role="form" class="form-horizontal" enctype="multipart/form-data"
          method="POST" action="{{ $base_url }}/{{ $item->id }}/update" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input id="sort" name="sort" type="number"
                           value="{{$item->sort}}" class="form-control" placeholder="排序">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input id="name" name="name" type="text"
                           value="{{$item->name}}" class="form-control" placeholder="名称">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input id="url" name="url" type="text"
                           value="{{$item->url}}" class="form-control" placeholder="链接">
                </div>
            </div>
        </div>
